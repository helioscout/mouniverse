...
\
Space worlds (game maps) with entities for this game you can create and edit with [moeditor](https://github.com/helioscout/moeditor) project. There you will find also description of the game storage (SQLite database) structure.
...
git clone https://github.com/helioscout/moecs.git
git clone https://github.com/helioscout/mouniverse.git
```
